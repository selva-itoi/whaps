...
const Chatbot: React.FC = () => {
  return (
    <><Helmet
      title={t`AI Chatbot - Automate Conversations & Boost Engagement`}
      meta={[
        {
          name: "description",
          content: t`Enhance customer interactions with AI-powered chatbot automation. Instantly respond, engage users, and optimize communication.`,
        },
        {
          name: "keywords",
          content: t`AI chatbot, WhatsApp chatbot, automated messaging, chatbot automation, customer engagement, AI-driven conversations`,
        },
        {
          property: "og:title",
          content: t`AI Chatbot - Automate Conversations & Boost Engagement`,
        },
        {
          property: "og:description",
          content: t`Streamline conversations with AI-powered chatbots. Provide instant replies, schedule messages, and track engagement effortlessly.`,
        },
        {
          property: "og:type",
          content: "website",
        ...
        {
          property: "og:image",
          content: "https://whaps.in/img/logo.jpg", // Update with your chatbot image URL
        },
        {
          property: "og:url",
          content: "https://whaps.in/services/chatbot",
        },
      ]}
    />
      <ServiceLayout
