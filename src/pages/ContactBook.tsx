...
const ContactBook: React.FC = () => {
  return (
    <><Helmet
      title={t`Smart Contact Book - Organize & Manage Your Contacts Efficiently`}
      meta={[
        {
          name: "description",
          content: t`Easily store, search, and manage contacts with our smart contact book. Secure, organized, and accessible anywhere.`,
        },
        {
          name: "keywords",
          content: t`contact book, contact management, organize contacts, phonebook, business contacts, secure contact storage, contact backup`,
        },
        {
          property: "og:title",
          content: t`Smart Contact Book - Organize & Manage Your Contacts Efficiently`,
        },
        {
          property: "og:description",
          content: t`Seamlessly manage your contacts with our feature-rich contact book. Secure, easy to use, and packed with powerful tools.`,
        },
        {
          property: "og:type",
          content: "website",
        ...
        {
          property: "og:image",
          content: "https://whaps.in/img/logo.jpg", // Update with your contact book image URL
        },
        {
          property: "og:url",
          content: "https://whaps.in/services/contact-book",
        },
      ]} /><ServiceLayout
        emoji=""
        title=""
